...
public class Factory_SpaceOnDemand
  extends Factory_Space  implements  Factory_SpaceOnDemand_
 {
  ...
  public void reset (CallContext context) {
    ...
    services_source_vector = null;
    locators_source_vector = null;
    super.reset(context);
  }
  ...
  protected void prepareInstanceAttributesFactory_SpaceOnDemand (CallContext call_context, Class_SpaceOnDemand instance) {
    ...
    instance.setServicesSources(context, this.getServicesSources(context));
    instance.setLocatorsSources(context, this.getLocatorsSources(context));
  ...
  { CallContext context = call_context; 
    return this.services_source_vector;
  }
  public void setServicesSources(CallContext call_context, Vector_DataSource_long_ services_source_vector) // uml association
  { CallContext context = call_context; 
  ...
  public Vector_DataSource_long_ defaultServicesSources(CallContext call_context) // uml association
  { CallContext context = call_context;
    return null;
  }
  ...
  { CallContext context = call_context; 
    return this.locators_source_vector;
  }
  public void setLocatorsSources(CallContext call_context, Vector_DataSource_long_ locators_source_vector) // uml association
  { CallContext context = call_context; 
  ...
  public Vector_DataSource_long_ defaultLocatorsSources(CallContext call_context) // uml association
  { CallContext context = call_context;
    return null;
  }
  ...
  public SpaceOnDemand mustCreateSpaceOnDemand (CallContext call_context) {
    ...
    static public SpaceOnDemand tryConstruct(CallContext context, Vector_DataSource_long_ super_space_source_vector, Vector_DataSource_long_ sub_space_source_vector, Vector_DataSource_long_ known_space_source_vector, Vector_DataSource_long_ services_source_vector, Vector_DataSource_long_ locators_source_vector) {
        return construct(context, super_space_source_vector, sub_space_source_vector, known_space_source_vector, services_source_vector, locators_source_vector);
    }

    static public SpaceOnDemand construct(CallContext context, Vector_DataSource_long_ super_space_source_vector, Vector_DataSource_long_ sub_space_source_vector, Vector_DataSource_long_ known_space_source_vector, Vector_DataSource_long_ services_source_vector, Vector_DataSource_long_ locators_source_vector)
        ...
        Factory_SpaceOnDemand __factory__ = new Factory_SpaceOnDemand(context);
          ...
          __factory__.setServicesSources(context, services_source_vector);
          __factory__.setLocatorsSources(context, locators_source_vector);
