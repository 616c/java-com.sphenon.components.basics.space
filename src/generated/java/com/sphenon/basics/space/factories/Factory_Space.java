...
public class Factory_Space implements Factory,  Factory_Space_
 {
  ...
  protected void prepareInstanceAttributesFactory_Space (CallContext call_context, Class_Space instance) {
    ...
    instance.setLocators(context, this.getLocators(context));
  ...
  { CallContext context = call_context; 
    return this.locator_vector;
  }
  public void setLocators(CallContext call_context, Vector_NamedLocator_long_ locator_vector) // uml association
  { CallContext context = call_context; 
  ...
  public Vector_NamedLocator_long_ defaultLocators(CallContext call_context) // uml association
  { CallContext context = call_context;
    return null;
  }
  ...
  public Space mustCreateSpace (CallContext call_context) {
    ...
    static public Space tryConstruct(CallContext context, Vector_Space_long_ super_space_vector, Vector_Space_long_ sub_space_vector, Vector_Space_long_ known_space_vector, Vector_Service_long_ service_vector, Vector_NamedLocator_long_ locator_vector, Vector_Object_long_ content_vector) {
        return construct(context, super_space_vector, sub_space_vector, known_space_vector, service_vector, locator_vector, content_vector);
    }

    static public Space construct(CallContext context, Vector_Space_long_ super_space_vector, Vector_Space_long_ sub_space_vector, Vector_Space_long_ known_space_vector, Vector_Service_long_ service_vector, Vector_NamedLocator_long_ locator_vector, Vector_Object_long_ content_vector)
        ...
        Factory_Space __factory__ = new Factory_Space(context);
          ...
          __factory__.setLocators(context, locator_vector);
    ...
    static public Space tryConstruct(CallContext context, Vector_Space_long_ super_space_vector, Vector_Space_long_ sub_space_vector, Vector_Space_long_ known_space_vector, Vector_Service_long_ service_vector, Vector_NamedLocator_long_ locator_vector, Vector_Object_long_ content_vector, String id, String name)
        // throws ValidationFailure
        // sollte der hier ja werfen duerfen, demnaechst mal vorsichtig enablen
        {
        return construct(context, super_space_vector, sub_space_vector, known_space_vector, service_vector, locator_vector, content_vector, id, name);
    }

    static public Space construct(CallContext context, Vector_Space_long_ super_space_vector, Vector_Space_long_ sub_space_vector, Vector_Space_long_ known_space_vector, Vector_Service_long_ service_vector, Vector_NamedLocator_long_ locator_vector, Vector_Object_long_ content_vector, String id, String name) {
        Factory_Space __factory__ = new Factory_Space(context);
