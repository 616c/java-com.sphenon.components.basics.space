...
public class VectorReferenceToMember_DataSource_long_
    implements ReferenceToMember_DataSource_long_ReadOnlyVector_DataSource_long__
{
    private ReadOnlyVector_DataSource_long_ vector;
    private long                          index;

    public VectorReferenceToMember_DataSource_long_ (CallContext context, ReadOnlyVector_DataSource_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_DataSource_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_DataSource_long_)) return false;
        if (((VectorReferenceToMember_DataSource_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_DataSource_long_) object).index  != this.index ) return false;
        return true;
    }
