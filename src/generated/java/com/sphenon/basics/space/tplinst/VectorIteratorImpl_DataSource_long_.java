...
public class VectorIteratorImpl_DataSource_long_
    implements IteratorItemIndex_DataSource_long_,
               Cloneable
{
    private ReadOnlyVector_DataSource_long_ vector;
    private long current_index;

    public VectorIteratorImpl_DataSource_long_ (CallContext context, ReadOnlyVector_DataSource_long_ vector) {
        this.vector = vector;
    ...
    public VectorIteratorImpl_DataSource_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_DataSource_long_) super.clone();
