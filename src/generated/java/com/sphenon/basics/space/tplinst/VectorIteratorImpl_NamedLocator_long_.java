...
public class VectorIteratorImpl_NamedLocator_long_
    implements IteratorItemIndex_NamedLocator_long_,
               Cloneable
{
    private ReadOnlyVector_NamedLocator_long_ vector;
    private long current_index;

    public VectorIteratorImpl_NamedLocator_long_ (CallContext context, ReadOnlyVector_NamedLocator_long_ vector) {
        this.vector = vector;
    ...
    public Reference_NamedLocator_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return vector.getReference(context, this.current_index);
    }

    public Reference_NamedLocator_ tryGetReferenceToCurrent (CallContext context) {
        return vector.tryGetReference(context, this.current_index);
    }

    public VectorIteratorImpl_NamedLocator_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_NamedLocator_long_) super.clone();
