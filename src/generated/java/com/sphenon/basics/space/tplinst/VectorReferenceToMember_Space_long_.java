...
public class VectorReferenceToMember_Space_long_
    implements ReferenceToMember_Space_long_ReadOnlyVector_Space_long__
{
    private ReadOnlyVector_Space_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Space_long_ (CallContext context, ReadOnlyVector_Space_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public Space get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Space_long_)) return false;
        if (((VectorReferenceToMember_Space_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Space_long_) object).index  != this.index ) return false;
        return true;
    }
