...
public class VectorReferenceToMember_Service_long_
    implements ReferenceToMember_Service_long_ReadOnlyVector_Service_long__
{
    private ReadOnlyVector_Service_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Service_long_ (CallContext context, ReadOnlyVector_Service_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Service_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Service get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Service_long_)) return false;
        if (((VectorReferenceToMember_Service_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Service_long_) object).index  != this.index ) return false;
        return true;
    }
