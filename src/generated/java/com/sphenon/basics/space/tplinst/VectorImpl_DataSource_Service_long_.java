...
public class VectorImpl_DataSource_Service_long_
  implements Vector_Service_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Service_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Service_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Service_long_(context, vector_source);
    }

    public Service get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Service) vector_source.get(context).elementAt((int) index);
    ...
    public Service set          (CallContext context, long index, Service item) {
        ...
        return (Service) vector_source.get(context).set((int) index, item);
    }
    ...
    public Service unset        (CallContext context, long index) {
        try {
            return (Service) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
