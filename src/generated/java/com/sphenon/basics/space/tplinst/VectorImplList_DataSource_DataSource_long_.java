...
public class VectorImplList_DataSource_DataSource_long_
  implements Vector_DataSource_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_DataSource_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_DataSource_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_DataSource_long_(context, vector_source);
    }

    public DataSource get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (DataSource) vector_source.get(context).get((int) index);
