...
public class VectorIterable_DataSource_long_ implements Iterable<DataSource>
{
    protected java.util.Iterator<DataSource> iterator;

    public VectorIterable_DataSource_long_ (CallContext context, Vector_DataSource_long_ vector) {
        this.iterator = (vector == null ? (new java.util.Vector<DataSource>()).iterator() : vector.getIterator_DataSource_(context));
    }
