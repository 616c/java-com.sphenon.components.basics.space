...
public class VectorIteratorImpl_Service_long_
    implements IteratorItemIndex_Service_long_,
               Cloneable
{
    private ReadOnlyVector_Service_long_ vector;
    private long current_index;

    public VectorIteratorImpl_Service_long_ (CallContext context, ReadOnlyVector_Service_long_ vector) {
        this.vector = vector;
    ...
    public Reference_Service_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return vector.getReference(context, this.current_index);
    }

    public Reference_Service_ tryGetReferenceToCurrent (CallContext context) {
        return vector.tryGetReference(context, this.current_index);
    }

    public VectorIteratorImpl_Service_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_Service_long_) super.clone();
